...
import { Leaf, Mail, Lock, Users, ArrowRight, Shield, Wallet } from 'lucide-react';
...
export default function Login() {
  const [credentials, setCredentials] = useState({ email: '', password: '', userType: 'farmer' });
        ...
        >
          ...
          <div className="bg-white/20 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/30">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-green-100">Sign in to your HerbsTrace account</p>
              
              <div className="inline-flex items-center bg-white/10 px-3 py-1 rounded-full mt-4">
                <Shield className="text-green-300 mr-2" size={16} />
                <span className="text-green-200 text-sm">Secure Login</span>
              </div>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-green-100">
                ...
                <a href="/signup" className="text-green-300 hover:text-green-200 font-semibold transition-colors">
                  Create Account
                </a>
              </p>
            </div>
